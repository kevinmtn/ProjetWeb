<?php //cette page permet de traiter la commande du client par rapport au panier lors de la validation de la commmande
$compte = array();
...
$intArray = array_map(
    function ($id_produits) {
        return (int)$id_produits;
    },  //convertion du tableau array string en int
    $stringArray
);
